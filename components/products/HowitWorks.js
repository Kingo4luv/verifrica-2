...
const HowItWorks = () => {
    return(
        ...
        <div className="w-full md:w-4/5 flex flex-col md:flex-row mx-auto px-4 md:px-0">
          <div className="w-full md:w-1/2 space-y-5">
            ...
            <h3 className="text-2xl md:text-4xl font-bold leading-tight  md:leading-snug">
              Introducing the future of <br /> financial payment in Africa
            </h3>
            </Slide>
            <Slide bottom>
            ...
            <div className="w-full md:w-100 space-y-1 sm:space-y-4">
          ...
          <div className="w-1/2 py-2 hidden justify-center items-center md:flex">
             <Zoom> 
             <img src="/assets/img/mobile-1.png" alt="phone"/>
             </Zoom>
          </div>
        </div>
      </section>
