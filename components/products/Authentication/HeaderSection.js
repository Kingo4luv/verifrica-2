...
import AuthenticationHeaderIcon from '../../../public/assets/svgs/authentication-header.svg'
import Nav from '../../nav';
const HeaderSection = () => {
    return(
        ...
        <div className="w-full md:w-11/12 xl:w-5/6 py-12 md:py-32 mx-auto flex flex-col md:flex-row px-4 md:px-0">
          <div className="w-full md:w-1/2 space-y-0 sm:space-y-12">
            <div className="w-full space-y-4 md:space-y-6">
              <h3 className="text-grey">Authentication</h3>
              ...
              <p className="text-grey text-sm md:text-base lg:text-lg pr-0 xl:pr-52">
          ...
          <div className="flex w-full md:w-1/2 items-center justify-center mt-12 md:mt-0">
            <div className="w-full">
                <img src={AuthenticationHeaderIcon} className="w-full" />
            </div>
          </div>
        </div>
      </header>
