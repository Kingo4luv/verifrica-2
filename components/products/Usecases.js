...
const UseCases = ({usecases}) => {
    return (
        <section className="py-16  w-full">
          <div className="w-full max-w-screen-xl mx-auto flex flex-col md:flex-row space-x-0 md:space-x-10 px-0 md:px-4">
              <div className="w-full md:w-1/3 px-4 md:px-0 relative space-y-2 max-w-xs mt-0 md:mt-8">
