...
const CareerPostionSection = () => {
    return(
        ...
        <div className="w-full max-w-[1100px] mx-auto px-4 mt-12 md:mt-0">
            <div className="flex flex-col lg:flex-row justify-between items-center space-y-12 lg:space-y-0">
                <Slide bottom>
                <h3 className="text-2xl md:text-3xl lg:text-3xl font-bold text-center md:text-left">Latest Positions </h3>
                </Slide>
                <div className="w-full md:w-auto space-x-0 md:space-x-6 flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
                    ...
                    <div className="w-full">
                        <Slide bottom>
                        <button className="w-full md:w-80 py-[0.6rem] md:py-2 border border-[#F1F1F1] rounded-[4px] bg-[#F1F1F1] px-4 leading-2 flex relative items-center text-grey text-sm font-light focus:outline-none ">
            ...
            <div className="grid  grid-col-1 sm:grid-cols-2 gap-x-10 lg:gap-x-40 mt-6">
                <div className="py-4 md:py-12 space-y-10">
                    <div className="space-y-2 md:space-y-8">
                        <Slide bottom>
                        <h3 className="text-lg md:text-2xl text-grey">Finance and Accounting</h3>
                        </Slide>
                        <Slide bottom cascade>
                        <dl className="space-y-2 md:space-y-4">
                            <dt className="font-bold">GTM Data Scientist</dt>
                    ...
                    <div className="space-y-2 md:space-y-8">
                        <Slide bottom>
                        <h3 className="text-lg md:text-2xl text-grey">Marketing</h3>
                        </Slide>
                        <Slide bottom cascade>
                        <dl className="space-y-2 md:space-y-4">
                            <dt className="font-bold">Account Based Marketing Manager</dt>
                            <dd className="text-sm md:text-base font-light">Abuja, Nigeria</dd>
                        </dl>
                        </Slide>
                    </div>
                ...
                <div className="py-4 md:py-12 space-y-10 mt-6 sm:mt-0 ">
                    <div className="space-y-2 md:space-y-8">
                        <Slide bottom>
                        <h3 className="text-lg md:text-2xl text-grey">Sales Business Systems</h3>
                        </Slide>
                        <Slide bottom cascade>
                        <dl className="space-y-2 md:space-y-4">
                            <dt className="font-bold">System Architect</dt>
                    ...
                    <div className="space-y-2 md:space-y-8">
                        <Slide bottom>
                        <h3 className="text-lg md:text-2xl text-grey">Legal</h3>
                        </Slide>
                        <Slide bottom cascade>
                        <dl className="space-y-2 md:space-y-4">
                            <dt className="font-bold">Privacy Counsel</dt>
                            <dd className="text-sm md:text-base font-light">Abuja, Nigeria</dd>
                        </dl>
                        </Slide>
                    </div>
