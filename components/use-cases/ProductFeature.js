    ...
    return(
        <section className="py-12 md:py-40  w-full">
          <div className="w-full max-w-screen-xl mx-auto flex flex-col md:flex-row">
              <div className="w-full max-w-sm px-4  relative space-y-2 md:pl-5 md:pr-3">
                  <h4 className="text-2xl lg:text-4xl font-medium leading-snug relative z-10 mt-0 md:mt-14">
                        Products & Benefits
                   </h4>
                   <p className="text-subtitle-3 sm:text-subtitle-2 text-grey max-w-sm">Fermentum vel massa blandit metus nam odio amet rhoncus. Praesent. </p>
              </div>
