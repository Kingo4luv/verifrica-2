...
const StarImage = () => {
    return (
        <section className="py-20 sm:py-32 flex flex-col md:flex-row px-4">
        <div className="w-full lg:w-7/12 flex flex-col justify-center items-center box-border">
            <div className="space-y-12 w-full md:w-11/12 xl:w-7/12">
              <dl className="text-black space-y-8">
                ...
                <dd className="font-light  text-sm md:text-base text-grey">
                  We are aware of the importance of your information. <br className="hidden lg:block" />Verifrica provides a secure, easy, and reliable to use <br className="hidden lg:block" /> platform where you can securely and reliably retrieve <br className="hidden lg:block" /> balance, past transactions, personal identity, etc. 
                </dd>
                </Slide>
              </dl>
              <Slide bottom>
              <div>
                <Link href="/" className="">
                  <a className="px-16 py-4 bg-blue rounded w-full block sm:inline text-center text-sm font-medium text-white tracking-wide mt-6">Learn more</a>
                </Link>
              </div>
                </Slide>
            </div>
        </div>
        <div className="w-full lg:w-6/12 mt-24 sm:mt-0 flex justify-start items-center">
            <div className="space-y-12 md:space-y-24 xl:space-y-32 w-full lg:w-5/6 xl:w-4/5">
